...
This repo treats dependency, workflow, and source changes as security-sensitive.
...
- Require review for `.github/workflows/`, `.github/actions/`, package manifests, lockfiles, `.npmrc`, `src/`, and release config.
