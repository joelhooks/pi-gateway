...
export class GatewayChannel extends Schema.Class("GatewayChannel")({
    id: Schema.String,
...
export class GatewayConfig extends Schema.Class("GatewayConfig")({
...
export class GatewayReceipt extends Schema.Class("GatewayReceipt")({
    at: Schema.String,
    event: Schema.String,
    note: Schema.optional(Schema.String),
}) {
}
export class GatewayMessage extends Schema.Class("GatewayMessage")({
    id: Schema.String,
...
export class GatewayAgentHeartbeat extends Schema.Class("GatewayAgentHeartbeat")({
    id: Schema.String,
    name: Schema.String,
...
export class GatewayState extends Schema.Class("GatewayState")({
    schemaVersion: Schema.Literal(1),
    updatedAt: Schema.String,
